...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            val minute = itemView.findViewById<TextView>(R.id.pager_tv_minute)
            val priorityColor = itemView.findViewById<ImageView>(R.id.item_priority_level)
            ...
            priorityColor.setImageResource(
                when (pageType) {
